  ...
  return (
    <section className="relative overflow-hidden py-20 sm:py-32">
      <div className="container relative z-10">
        ...
        >
          <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold tracking-tight mb-8 leading-relaxed bg-clip-text text-transparent bg-gradient-to-r from-purple-500 via-cyan-500 to-purple-500">
            {t('heroTitle')}
          </h1>
          ...
          >
            ...
            <img
              ...
              alt="CodeFalcon Logo"
              className="relative w-full h-full object-contain p-4 drop-shadow-[0_0_25px_rgba(139,92,246,0.3)]"
            />
          </motion.div>
        </motion.div>
      </div>
